...
//    case WM_CREATE: {
//        
//        SetWindowText(hWnd, ("MixPlayer Beta 1.9 © StrannikCorp"));
...
//            AppendMenu(hMenubar, MF_POPUP, (UINT_PTR)hOptions, "Сменить цвет");
//
//
//
...
//
//            AppendMenu(hOptions, MF_STRING, RED, "Красный");
//            AppendMenu(hOptions, MF_STRING, ORANGE, "Оранжевый");
//            AppendMenu(hOptions, MF_STRING, YELLOW, "Жёлтый");
//            AppendMenu(hOptions, MF_STRING, GREEN, "Зелёный");
//            AppendMenu(hOptions, MF_STRING, AZURE, "Голубой");
//            AppendMenu(hOptions, MF_STRING, BLUE, "Синий");
//            AppendMenu(hOptions, MF_STRING, VIOLET, "Фиолетовый");
//            AppendMenu(hOptions, MF_STRING, STANDART, "Стандартный");
//
...
//            
//           
//            CreateWindow(TEXT("STATIC"), TEXT("MixPlayer Version Beta 1.9, copyright ©StrannikCorp. All rights reserved"), WS_VISIBLE | WS_CHILD, 400, 20, 475, 25, hWnd, (HMENU)NULL, NULL, NULL);
...
//            CreateWindow(TEXT("STATIC"), TEXT("Тут уже имеется пара композиций"), WS_VISIBLE | WS_CHILD, 500, 100, 230, 20, hWnd, (HMENU)NULL, NULL, NULL);
//            string Priet = "C:\\Windows\\media\\Windows Logon.wav";
//            PlaySoundA(Priet.c_str(), NULL, SND_ASYNC);
//            string strstr = "MusicPlayer\\BMP\\str.bmp";
...
//        {
//            system("start MusicPlayer\\COLORS\\RED.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == ORANGE)
//        {
//            system("start MusicPlayer\\COLORS\\ORANGE.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == YELLOW)
//        {
//            system("start MusicPlayer\\COLORS\\YELLOW.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == GREEN)
//        {
//            system("start MusicPlayer\\COLORS\\GREEN.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == AZURE)
//        {
//            system("start MusicPlayer\\COLORS\\AZURE.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == BLUE)
//        {
//            system("start MusicPlayer\\COLORS\\BLUE.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == VIOLET)
//        {
//            system("start MusicPlayer\\COLORS\\VIOLET.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//        if (LOWORD(wParam) == STANDART)
//        {
//            system("start MusicPlayer\\COLORS\\STANDART.EXE");
//            PostQuitMessage(0);
//            return 0;
//        }
//
