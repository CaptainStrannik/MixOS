...
static LRESULT CALLBACK wnd_proc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        CreateWindow(TEXT("STATIC"), TEXT("Список эмуляторов версия 2.1"), WS_VISIBLE | WS_CHILD, 500, 18, 210-5, 18, hWnd, (HMENU)text1, NULL, NULL);
        ...
        CreateWindow(TEXT("STATIC"), TEXT("Мой сборник игры детства"), WS_VISIBLE | WS_CHILD, 500 - 10+500-40+20, 600, 228, 18, hWnd, (HMENU)text1, NULL, NULL);
