...
static LRESULT CALLBACK wnd_proc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        CreateWindow(TEXT("BUTTON"), TEXT("Эмуляторы (LITE!!!)"), WS_VISIBLE | WS_CHILD | WS_TABSTOP|WS_DISABLED, 650, 200, 500, 300, hWnd, (HMENU)Emulators, NULL, NULL);
        ...
        CreateWindow(TEXT("BUTTON"), TEXT("Квест (LITE!!!)"), WS_VISIBLE | WS_CHILD | WS_TABSTOP| WS_DISABLED, 650, 530, 500, 100, hWnd, (HMENU)QUEST, NULL, NULL);
        ...
        CreateWindow(TEXT("BUTTON"), TEXT("Пианино (LITE!!!)"), WS_VISIBLE | WS_CHILD | WS_TABSTOP| WS_DISABLED, 650, 80, 500, 100, hWnd, (HMENU)PIANINO, NULL, NULL);
        ...
        CreateWindow(_T("BUTTON"), _T("Запустить все подпрограммы MixOS при нажатии на кнопку \"Плеер\""), WS_VISIBLE | WS_CHILD | BS_CHECKBOX | BS_AUTOCHECKBOX|WS_DISABLED,
    ...
    case WM_COMMAND: {
        ...
        if (LOWORD(wParam) == ID_BUTTON)
        {
           ...
           /* SendMessage(hWnd, WM_SETICON, NULL, (LPARAM)hIcon2);*/
            ...
            SetWindowText(hWnd, "MixPlayer Pre Beta 2.3 из MixOS Lite");
           ...
           /* Proga1.close();*/
            ...
            AppendMenu(hMenubar, MF_POPUP|MF_DISABLED, (UINT_PTR)hRasvl, "Развлечения");
            AppendMenu(hMenubar, MF_POPUP, (UINT_PTR)hOptions, "Настройки");
            AppendMenu(hMenubar, MF_POPUP|MF_DISABLED, (UINT_PTR)hWhat, "С чего начиналась разработка?");
            ...
            AppendMenu(hCreator, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hCreator, MF_STRING|MF_DISABLED, DUSHA, "Душа");
            AppendMenu(hCreator, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hCreator, MF_STRING|MF_DISABLED, POL, "Пол");
            AppendMenu(hCreator, MF_SEPARATOR, NULL, NULL);
            ...
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, QUEST, "Поиграть в шашнахме квест");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, PIANINO, "Поиграть на пианино");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING, TERMINAL, "Открыть терминал");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, CONVERTER, "Открыть конвертер валют");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            ...
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, ERTOR, "Открыть генератор случайных чисел");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING, VIDEO, "Открыть видеоплеер");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, PHOTOVIEWER, "Открыть просмотрщик фотографий");
            AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hHelp, MF_STRING| MF_DISABLED, TRANSLATE, "Открыть руингтранслит");
            //AppendMenu(hHelp, MF_SEPARATOR, NULL, NULL);
            ...
            AppendMenu(hInstall, MF_STRING| MF_DISABLED, VISUAL, "Установить Visual C++ редисты");
            AppendMenu(hInstall, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hInstall, MF_STRING| MF_DISABLED, VISUALSTUDIO, "Установить Visual Studio 2022");
            AppendMenu(hInstall, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hInstall, MF_STRING| MF_DISABLED, OBS, "Установить OBS");
            AppendMenu(hInstall, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hInstall, MF_STRING, VEGAS, "Открыть CPU-Z");
            AppendMenu(hInstall, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hInstall, MF_STRING, HW, "Открыть HW monitor");
            AppendMenu(hInstall, MF_SEPARATOR, NULL, NULL);
            AppendMenu(hInstall, MF_STRING| MF_DISABLED, BOMB, "Открыть Revo Uninstaller");



            AppendMenu(hRasvl, MF_STRING| MF_DISABLED, EMULATE, "Эмуляторы");
            AppendMenu(hRasvl, MF_STRING| MF_DISABLED, COMP4, "Компьютерная эволюция 4");
            ...
            CreateWindow(TEXT("STATIC"), TEXT("MixPlayer Pre Beta 2.3. copyright ©StrannikCorp. All rights reserved"), WS_VISIBLE | WS_CHILD, 400, 20, 475, 25, hWnd, (HMENU)text1, NULL, NULL);
