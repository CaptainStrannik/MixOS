...
//
//
//        CreateWindowA(TEXT("BUTTON"), TEXT("Включить читы"), WS_VISIBLE | WS_CHILD|WS_DISABLED, 10 + 160, 350 + 100, 150, 35, hWnd, (HMENU)GTX745, NULL, NULL);
//
...
//
//        CreateWindowA(TEXT("BUTTON"), TEXT("Windows 3.11"), WS_VISIBLE | WS_CHILD|WS_DISABLED, 10, 350 + 100, 150, 35, hWnd, (HMENU)WIN311, NULL, NULL);
//
